...
exports.retailLogin = exports.otpVerification = exports.resendOTP = exports.retailValidation = void 0;
...
const resendOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const generatedOTP = Math.floor(100000 + Math.random() * 900000);
        const fetchUser = yield RetailerAdmin_1.retailerAdmin.findOneAndUpdate({ email: req.body.email }, { otpCode: generatedOTP }, { new: true });
        console.log('Generated otp is ', generatedOTP);
        const transporter = nodemailer_1.default.createTransport({
            service: 'Gmail',
            auth: {
